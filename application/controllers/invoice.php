...
class invoice extends CI_Controller {
    ...
    public function print_invoice($parameter, $print ='0', $default = "0"){
        ...
        $datos = $this->mdl_clients->get_last_invoice($parameter);
        ...
        if ($default === "2") {
            ...
            if (empty($datos['resultado'][0]['ultimoid'])){
            ...
            $variables = array(
                ...
                //'tabla' => '',
                'cliente' => "Juan Castillo",
                'id_invoice' => $datos['resultado'][0]['ultimoid'],
                'contract' => $parameter,
            ...
            $html2pdf->Output( $parameter . ' ' . $datos['resultado'][0]['Fecha'] . ' ' . $datos['resultado'][0]['ultimoid'] . '.pdf');
        } elseif ($default === "1") {
